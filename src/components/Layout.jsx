...
const navItems = [
  ...
  { id: 'residents',   label: 'Residents',           icon: '👤', section: 'care' },
  { id: 'medications', label: 'Medications (eMAR)',  icon: '💊', section: 'care' },
  { id: 'dailylogs',   label: 'Daily Logs',          icon: '📋', section: 'care' },
  { id: 'incidents',   label: 'Incidents',           icon: '⚠️', section: 'care' },
